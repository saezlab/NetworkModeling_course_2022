...
if(!requireNamespace("CellNOptR", quietly = TRUE)) BiocManager::install("CellNOptR")
if(!requireNamespace("CNORode", quietly = TRUE)) BiocManager::install("CNORode")
if(!requireNamespace("MEIGOR", quietly = TRUE)) BiocManager::install("MEIGOR")
...
```{r message=FALSE}
IC50 <- read_csv("./data/tutorial_3/IC50_GDSC.csv") %>% rename("cell_line" = "...1")
print(IC50)
```

```{r message=FALSE}
IC50 %>% pivot_longer(names_to = "drug_name", values_to = "log_IC50", -cell_line) %>%
  ggplot() +
